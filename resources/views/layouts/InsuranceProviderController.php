...
class InsuranceProviderController extends Controller
{
    ...
    public function getComputationRates($providerId, $productId) {
            ...
            $ownDamageComputations = InsuranceComputation::select(
                ...
                'insurance_computations.set_limit_minimum as ownDamageSetLimitMinimum',
                'insurance_computations.set_limit_maximum as ownDamageSetLimitMaximum',

                'insurance_computations.set_rate_minimum as ownDamageSetRateMinimum',
                'insurance_computations.set_rate_maximum as ownDamageSetRateMaximum',
            ...
            $bodilyInjuryComputations = InsuranceComputation::select(
                ...
                'insurance_computations.set_limit_minimum as bodilyInjurySetLimit',


                'insurance_computations.set_rate_minimum as bodilyInjurySetRate',
            ...
            $propertyDamageComputations = InsuranceComputation::select(
                'insurance_coverages.coverage_name',
                'insurance_computations.set_limit_minimum as propertyDamageSetLimit',
                'insurance_computations.set_rate_minimum as propertyDamageSetRate',
            ...
            $autoPaComputations = InsuranceComputation::select(
                'insurance_coverages.coverage_name',
                'insurance_computations.set_limit_minimum as autoPaSetLimit',
            )
            ->where('provider_product_id', $providerProduct->id)
